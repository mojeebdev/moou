...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className="fixed top-0 left-0 right-0 z-50 flex md:grid md:grid-cols-[1fr_auto_1fr] items-center justify-between md:justify-normal max-md:pl-6 max-md:pr-[10%] md:px-[clamp(24px,6vw,80px)] border-b border-[var(--void-05)]"
        style={{
      ...
      >
        ...
        {/* Right — desktop CTA / mobile hamburger (inset from right edge) */}
