...
server.tool('moou_deploy_prompt', 'Generate getagent and GetAgent Studio prompts to deploy a MÓOU-compiled strategy to Bitget Playbook.', {
    strategy_name: z.string(),
    entry_conditions: z.string(),
    exit_conditions: z.string(),
    position_sizing: z.string(),
    ...
    const risk = Object.fromEntries(riskEntries.filter(([, value]) => value !== undefined));
